      ...
      <div className="relative w-full max-w-sm mx-auto">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-1 mb-4 justify-center">
          {["10 free daily generations", "All content types", "No credit card"].map((f) => (
            <span key={f} className="inline-flex items-center gap-1 text-[11px] text-emerald-400">
              <Check className="h-2.5 w-2.5 shrink-0" />{f}
            </span>
          ))}
        </div>
        ...
        <Card>
          <CardContent className="p-5 sm:p-6 space-y-4">
            ...
            <p className="text-center text-xs text-white/30">
              ...
              and <Link href="#" className="text-violet-400 hover:underline">Privacy Policy</Link>
            </p>
          </CardContent>
        </Card>
